...
import org.cdaz.mq.config.MqttConfig;
...
public class MqttClientServiceImpl implements MqttClientService {
    ...
    public void publish(String topic, MqttMessage message) {
        try {
            ...
            Logger.info("Publish mqtt message, topic = {}", topic);
    ...
    @Override
    public void sucribe(String[] topicFilters, int[] qos, IMqttMessageListener[] listener) {
        try {
